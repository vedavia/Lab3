...
public class JSONTranslationExample {
    ...
    public static final String CODE_FORMAT = "alpha3";
    ...
    public String getCountryNameTranslation(String countryCode, String languageCode) {
        ...
        while (idx < jsonArray.length()) {
            if (jsonArray.getJSONObject(idx).getString(CODE_FORMAT).equals(countryCode)){
                break;
            }
            idx ++;
        }
        JSONObject country = jsonArray.getJSONObject(idx);
